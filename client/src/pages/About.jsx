      ...
      <div className="max-w-2xl mx-auto p-3 text-center">
        <div>
          ...
          <div className="text-md text-gray-500 flex flex-col gap-6">
            <p>
              Welcome to {"Vaibhav's"} Blog! This blog was created by Vaibhav
              Varshney as a personal project to share his thoughts and ideas
            ...
            <p>
              ...
              programming languages. Vaibhav is always learning and exploring
